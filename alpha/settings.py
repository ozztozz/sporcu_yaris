...
SECRET_KEY = 'django-insecure-@fepd#w$5+641a+lhu&1zg2th%q)l6dg21id^iz5!978o29@yb'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['ozz1.pythonanywhere.com','127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # tailwind
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
